/**
 * =========================================================================================
 * Project     : Arduino Uno Wearable Fall Detection Pendant with 6-Axis IMU & GSM
 * Platform    : Arduino Uno / ATmega328P
 * Framework   : Arduino IDE 2.0+
 * Author      : Muhammad Fikri
 * License     : MIT
 * Description : Elderly care fall detector calculating Acceleration Vector Magnitude (AVM) and sudden rotational velocity changes, triggering auto-canceling buzzer and GSM SMS alarm.
 * =========================================================================================
 */
...
void setup() {
    ...
    Serial.println(F("================================================================="));
    Serial.println(F(" Arduino Uno Wearable Fall Detection Pendant with 6-Axis IMU & GSM"));
